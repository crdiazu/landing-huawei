      ...
      <div className="subpage-content" style={{ color: 'white' }}>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', textAlign: 'left' }}>
            <div style={{ backgroundColor: 'rgba(42, 42, 42, 0.8)', padding: '40px 30px', borderRadius: '16px', backdropFilter: 'blur(10px)', borderTop: '4px solid #1F4E79', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
              <i className="fa-solid fa-tags" style={{ fontSize: '2.5rem', color: '#4A7C59', marginBottom: '20px' }}></i>
            ...
            <div style={{ backgroundColor: 'rgba(42, 42, 42, 0.8)', padding: '40px 30px', borderRadius: '16px', backdropFilter: 'blur(10px)', borderTop: '4px solid #1F4E79', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
              <i className="fa-solid fa-display" style={{ fontSize: '2.5rem', color: '#4A7C59', marginBottom: '20px' }}></i>
            ...
            <div style={{ backgroundColor: 'rgba(42, 42, 42, 0.8)', padding: '40px 30px', borderRadius: '16px', backdropFilter: 'blur(10px)', borderTop: '4px solid #1F4E79', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
              <i className="fa-solid fa-headset" style={{ fontSize: '2.5rem', color: '#4A7C59', marginBottom: '20px' }}></i>
          ...
          <div style={{ textAlign: 'center', marginTop: '60px' }}>
            <a href="/contacto" className="btn-primary huawei-brand-font" style={{ display: 'inline-block', padding: '15px 40px', backgroundColor: '#1F4E79', border: '2px solid #1F4E79', color: 'white', textDecoration: 'none', borderRadius: '8px', fontSize: '1.2rem', transition: 'all 0.3s' }}>
